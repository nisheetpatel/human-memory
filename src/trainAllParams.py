...
def trainAllParams(lmdas, sigmaBases, delta_pmts, delta_1s, delta_2s, save_path="./figures/",
	...
	for params in itertools.product(lmdas, sigmaBases,
		...
		exptGroup = ExperimentGroup(nExperiments=nExperimentsPerParamSet, savePath=save_path, **paramsDict)
